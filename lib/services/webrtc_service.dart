...
class WebRTCService {
  ...
  Future<void> init() async {
    ...
    _pc!.onAddStream.listen((e) {
      if (e.stream != null) onRemoteStream?.call(e.stream!);
    });
  }
  ...
  Future<void> startCall(bool isVideo) async {
    ...
    onSignal?.call('call_invite', {
      'sdp': offer.sdp, 'type': isVideo ? 'video' : 'voice'
    });
  }
  ...
  void _startDuration() {
    ...
    _durationTimer = Timer.periodic(
      ...
      (_) { _callSeconds++; onDuration?.call(_callSeconds); },
    );
  }
